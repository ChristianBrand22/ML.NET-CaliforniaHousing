...
namespace SampleRegression.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\efend\ML\CaliforniaHousing\california_housing_train.csv";
        private static string TEST_DATA_FILEPATH = @"C:\Users\efend\ML\CaliforniaHousing\california_housing_test.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Concatenate("Features", new[] { "longitude", "latitude", "housing_median_age", "population", "households", "median_income" });
